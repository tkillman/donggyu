...
public class Test3 {
	...
	public static void main(String[] args) {
		...
		/*
		call by value = 데이터값을 복사해서 넘겨서 서로 다른 메모리 공간에 존재하게 된다.
		call by reference = 서로 같은 메모리 공간의 값을 참조*/		
		
			/*정적 메모리 스택 영역 -정수형 변수, 실수형 변수, 논리형 변수를 실제값으로 저장
			
			동적 메모리 힙 영역 -객체와 배열이 생성되는 공간, 
			참조타입(배열,열거,클래스,인터페이스)들을 힙 영역에 저장
			*/
	} // 메인 메소드 종료
